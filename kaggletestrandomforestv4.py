# -*- coding: utf-8 -*-
"""KaggleTestRandomForestv4.ipynb
...
def main():
    ...
    # Collect user input
    q11 = st.slider("For how many years have you been writing code and/or programming?", 0, 100, 50)
    q30 = st.slider("how much money have you spent on machine learning and/or cloud computing services at home or at work in the past 5 years", 0, 100, 50)
    q27 = st.slider("Does your current employer incorporate machine learning methods into their business?", 0, 100, 50)
    ...
    q26 = st.slider("Approximately how many individuals are responsible for data science workloads at your place of business?", 0, 100, 50)
    q23 = st.slider("Select the title most similar to your current role", 0, 100, 50)
